...
#ifndef DM_ERROR_TYPE_3RD_H
#define DM_ERROR_TYPE_3RD_H
...
enum {
    ...
    ERR_DM_GET_LOCAL_USERID_FAILED = 96929841,
    ERR_DM_CAPABILITY_NEGOTIATE_FAILED = 96929842,
    ERR_DM_BINDTARGET_SCREEN_LOCK = 96929844,
    ERR_DM_NO_REPLAY = 96929845,
    ERR_DM_GET_TOKENID_FAILED = 96929846,
    ERR_DM_SHOW_CONFIRM_FAILED = 96929847,
    ERR_DM_PARSE_MESSAGE_FAILED = 96929848,
    ERR_DM_GET_BMS_FAILED = 96929849,
    ERR_DM_DESERIAL_CERT_FAILED = 96929850,
    ERR_DM_VERIFY_CERT_FAILED = 96929851,
    ERR_DM_GET_PARAM_FAILED = 96929852,
    ERR_DM_VERIFY_SAME_ACCOUNT_FAILED = 96929853,
    ERR_DM_GET_BUNDLE_NAME_FAILED = 96929854,
    ERR_DM_DEVICE_FROZEN = 96929855,
    ERR_DM_SOCKET_IN_USED = 96929856,
    ERR_DM_ANTI_DISTURB_MODE = 96929857,
    ERR_DM_SKIP_AUTHENTICATE = 96929858,
    ERR_DM_SERVICE_BIND_PEER_SERVICE_ID_UNPUBLISH = 96929859,
    ERR_DM_SERVICE_INFO_NOT_EXIST = 96929860,
    ERR_DM_SERVICE_HAS_BEEN_REGISTER = 96929861,
    ERR_DM_SERVICE_GEN_REGISTER_ID_FAILED = 96929862,
    ERR_DM_BIND_PIN_XOR_MISMATCH = 96929863,
};
} // namespace DistributedHardware
} // namespace OHOS
#endif // DM_ERROR_TYPE_3RD_H