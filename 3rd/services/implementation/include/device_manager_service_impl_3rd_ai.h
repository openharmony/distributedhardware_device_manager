...
#ifndef OHOS_DM_SERVICE_IMPL_3RD_AI_H
#define OHOS_DM_SERVICE_IMPL_3RD_AI_H
...
class DeviceManagerServiceImpl3rdAi : public IDeviceManagerServiceImpl3rd {
public:
    DeviceManagerServiceImpl3rdAi();
    virtual ~DeviceManagerServiceImpl3rdAi();
...
using CreateDMServiceImpl3rdAiFuncPtr = IDeviceManagerServiceImpl3rd *(*)(void);
} // namespace DistributedHardware
} // namespace OHOS
#endif // OHOS_DM_SERVICE_IMPL_3RD_AI_H