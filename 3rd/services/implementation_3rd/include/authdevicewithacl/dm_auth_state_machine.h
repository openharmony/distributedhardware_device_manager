...
#ifndef OHOS_DM_AUTH_STATE_MACHINE_ACL_H
#define OHOS_DM_AUTH_STATE_MACHINE_ACL_H
...
private:
    ...
    DmAuthStateType preState_{DmAuthStateType::ACL_AUTH_IDLE_STATE};  // Previous push state
...
#endif // OHOS_DM_AUTH_STATE_MACHINE_ACL_H
