...
public:
    ...
    ::taihe::array<::ohos::distributedDeviceManager::DeviceIdToUdid> GetUdidsByDeviceIds(
...
private:
    ...
    void JsToBindParam(ani_env *env,
    ...
    void LockSuccDiscoveryCallbackMutex(const std::string &bundleName,
        std::map<std::string, std::string> &discParam, const std::string &extra);
    bool JsToDiscoverTargetType(ani_env *env,
        const ::taihe::map_view<::taihe::string, ::ohos::distributedDeviceManager::IntAndStrUnionType> &object,
        int32_t &discoverTargetType);
    void JsToDmDiscoveryExtra(ani_env *env,
        const ::taihe::map_view<::taihe::string, ::ohos::distributedDeviceManager::IntAndStrUnionType> &object,
        std::string &extra);
    void JsToDiscoveryParam(ani_env *env,
        const ::taihe::map_view<::taihe::string, ::ohos::distributedDeviceManager::IntAndStrUnionType> &object,
