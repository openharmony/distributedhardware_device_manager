...
DmAniDiscoveryFailedCallback::DmAniDiscoveryFailedCallback(std::string &bundleName,
    ...
    ohos::distributedDeviceManager::DiscoveryFailureResult const&)>>(discoverFailedCallback))
{
}
...
DmAniDiscoverySuccessCallback::DmAniDiscoverySuccessCallback(std::string &bundleName,
    ...
    ohos::distributedDeviceManager::DiscoverySuccessResult const&)>>(discoverSuccessCallback))
{
}
