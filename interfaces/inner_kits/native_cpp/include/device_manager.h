...
public:
    ...
    */
    ...
    virtual int32_t StopServiceDiscovery(const std::string &pkgName, int32_t discoveryServiceId) { return 0; }
    ...
    virtual int32_t UnbindServiceTarget(const std::string &pkgName, int64_t serviceId) { return 0; }
    ...
    virtual int32_t StartPublishService(const std::string &pkgName, const PublishServiceParam &publishServiceParam,
        std::shared_ptr<ServicePublishCallback> callback, int64_t &serviceId) { return 0; }
    virtual int32_t StopPublishService(int64_t serviceId) { return 0; }
    virtual int32_t RegisterServiceInfo(const ServiceRegInfo &serviceRegInfo, int32_t &regServiceId) { return 0; }
    virtual int32_t UnRegisterServiceInfo(int32_t regServiceId) { return 0; }
