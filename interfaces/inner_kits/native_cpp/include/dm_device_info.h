...
typedef enum {
    ...
    STATUS_DM_AUTH_CONFIRM,
    STATUS_DM_AUTH_ADD_MEMBER,
    STATUS_DM_AUTH_NETWORK,
    STATUS_DM_AUTH_FINISH,
    STATUS_DM_SHOW_AUTHORIZE_UI = 100,
    STATUS_DM_CLOSE_AUTHORIZE_UI,
    STATUS_DM_SHOW_PIN_DISPLAY_UI,
    STATUS_DM_CLOSE_PIN_DISPLAY_UI,
    STATUS_DM_SHOW_PIN_INPUT_UI,
    STATUS_DM_CLOSE_PIN_INPUT_UI,
} DmAuthStatus;
