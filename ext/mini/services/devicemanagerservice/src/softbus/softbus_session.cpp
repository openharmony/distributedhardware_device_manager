...
static void StreamReceived(int sessionId, const StreamData *data, const StreamData *ext, const StreamFrameInfo *param)
{
    (void)sessionId;
    (void)data;
    (void)ext;
...
void SoftbusSession::OnBytesReceived(int sessionId, const void *data, int dataLen)
{
