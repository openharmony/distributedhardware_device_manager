...
#else
        DeviceManagerNotify::GetInstance().OnAuthResult(mHostPkgName_, deviceId, mPinToken_, FAIL, errorCode);
#endif
...
#else
    DeviceManagerNotify::GetInstance().OnAuthResult(mHostPkgName_, deviceId, mPinToken_, SUCCESS, errorCode);
#endif
}
}
}
