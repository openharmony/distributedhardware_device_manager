...
HWTEST_F(DmPublishCommonEventManagerTest, SubscribePublishCommonEvent_001, testing::ext::TestSize.Level0)
{
...
HWTEST_F(DmPublishCommonEventManagerTest, UnsubscribePublishCommonEvent_001, testing::ext::TestSize.Level0)
{
    std::shared_ptr<DmPublishCommonEventManager> publshCommonEventManager
        = std::make_shared<DmPublishCommonEventManager>();
