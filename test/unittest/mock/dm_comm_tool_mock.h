 ...
 */
#ifndef OHOS_DM_COMM_TOOL_MOCK_H
#define OHOS_DM_COMM_TOOL_MOCK_H
...
public:
    MOCK_METHOD(int32_t, SendUserIds, (const std::string, const std::vector<uint32_t> &,
