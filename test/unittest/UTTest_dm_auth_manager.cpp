...
HWTEST_F(DmAuthManagerTest, AuthenticateDevice_002, testing::ext::TestSize.Level0)
{
    ...
    std::shared_ptr<DeviceManagerServiceListener> listener = std::make_shared<DeviceManagerServiceListener>();
    std::shared_ptr<DmAuthManager> authManager = std::make_shared<DmAuthManager>(softbusConnector, listener);
    std::shared_ptr<AuthResponseState> authResponseState = std::shared_ptr<AuthResponseState>(new AuthResponseInitState());
...
HWTEST_F(DmAuthManagerTest, VerifyAuthentication_001, testing::ext::TestSize.Level0)
{
    ...
    std::shared_ptr<DeviceManagerServiceListener> listener = std::make_shared<DeviceManagerServiceListener>();
    std::shared_ptr<DmAuthManager> authManager = std::make_shared<DmAuthManager>(softbusConnector, listener);
    std::shared_ptr<AuthRequestState> authRequestState = std::shared_ptr<AuthRequestState>(new AuthRequestNetworkState());
...
HWTEST_F(DmAuthManagerTest, HandleAuthenticateTimeout_002, testing::ext::TestSize.Level0)
{
    ...
    std::shared_ptr<DeviceManagerServiceListener> listener = std::make_shared<DeviceManagerServiceListener>();
    std::shared_ptr<DmAuthManager> authManager = std::make_shared<DmAuthManager>(softbusConnector, listener);
    std::shared_ptr<AuthRequestState> authRequestState = std::shared_ptr<AuthRequestState>(new AuthRequestFinishState());
    authManager->authResponseContext_ = std::make_shared<DmAuthResponseContext>();
    authManager->authRequestContext_ = std::make_shared<DmAuthRequestContext>();
...
HWTEST_F(DmAuthManagerTest, SendAuthRequest_001, testing::ext::TestSize.Level0)
{
    ...
    std::shared_ptr<DeviceManagerServiceListener> listener = std::make_shared<DeviceManagerServiceListener>();
    std::shared_ptr<DmAuthManager> authManager = std::make_shared<DmAuthManager>(softbusConnector, listener);
    std::shared_ptr<AuthRequestState> authRequestState = std::shared_ptr<AuthRequestState>(new AuthRequestNegotiateState());
...
HWTEST_F(DmAuthManagerTest, StartAuthProcess_001, testing::ext::TestSize.Level0)
{
    ...
    std::shared_ptr<DeviceManagerServiceListener> listener = std::make_shared<DeviceManagerServiceListener>();
    std::shared_ptr<DmAuthManager> authManager = std::make_shared<DmAuthManager>(softbusConnector, listener);
    std::shared_ptr<AuthResponseState> authResponseState = std::shared_ptr<AuthResponseState>(new AuthResponseConfirmState());
    authManager->authResponseContext_ = std::make_shared<DmAuthResponseContext>();
    authManager->authRequestContext_ = std::make_shared<DmAuthRequestContext>();
    authManager->authResponseState_ = std::shared_ptr<AuthResponseState>(new AuthResponseConfirmState());
    authManager->SetAuthResponseState(authResponseState);
    int32_t action = 0;
...
HWTEST_F(DmAuthManagerTest, SetAuthResponseState_001, testing::ext::TestSize.Level0)
{
    ...
    std::shared_ptr<DeviceManagerServiceListener> listener = std::make_shared<DeviceManagerServiceListener>();
    std::shared_ptr<DmAuthManager> authManager = std::make_shared<DmAuthManager>(softbusConnector, listener);
    std::shared_ptr<AuthResponseState> authResponseState = std::shared_ptr<AuthResponseState>(new AuthResponseFinishState());
    authManager->authResponseState_ = std::shared_ptr<AuthResponseState>(new AuthResponseFinishState());
    authManager->SetAuthResponseState(authResponseState);
