...
/**
 * @tc.name: AuthResponseSyncDeleteAcl::GetStateType_011
 * @tc.desc: 1 set authManager to null
 *           2 call AuthResponseSyncDeleteAcl::GetStateType with authManager = null
 *           3 check ret is AUTH_RESPONSE_SYNCDELETE
 * @tc.type: FUNC
 * @tc.require: AR000GHSJK
 */
HWTEST_F(AuthResponseStateTest, GetStateType_011, testing::ext::TestSize.Level0)
{
    std::shared_ptr<AuthResponseState> authResponseState = std::make_shared<AuthResponseSyncDeleteAcl>();
    int32_t ret = authResponseState->GetStateType();
    ASSERT_EQ(ret, AUTH_RESPONSE_SYNCDELETE);
}

/**
 * @tc.name: AuthResponseSyncDeleteAcl::Enter_013
 * @tc.desc: 1 set authManager to null
 *           2 call AuthResponseSyncDeleteAcl::Enter with authManager = null
 *           3 check ret is ERR_DM_FAILED
 * @tc.type: FUNC
 * @tc.require: AR000GHSJK
 */
...
/**
 * @tc.name: AuthResponseSyncDeleteAclNone::GetStateType_012
 * @tc.desc: 1 set authManager to null
 *           2 call AuthResponseSyncDeleteAclNone::GetStateType with authManager = null
 *           3 check ret is AUTH_RESPONSE_SYNCDELETE_DONE
 * @tc.type: FUNC
 * @tc.require: AR000GHSJK
 */
HWTEST_F(AuthResponseStateTest, GetStateType_012, testing::ext::TestSize.Level0)
{
    std::shared_ptr<AuthResponseState> authResponseState = std::make_shared<AuthResponseSyncDeleteAclNone>();
    int32_t ret = authResponseState->GetStateType();
    ASSERT_EQ(ret, AUTH_RESPONSE_SYNCDELETE_DONE);
}

/**
 * @tc.name: AuthResponseSyncDeleteAclNone::Enter_014
 * @tc.desc: 1 set authManager to null
 *           2 call AuthResponseSyncDeleteAclNone::Enter with authManager = null
 *           3 check ret is ERR_DM_FAILED
 * @tc.type: FUNC
 * @tc.require: AR000GHSJK
 */
HWTEST_F(AuthResponseStateTest, Enter_014, testing::ext::TestSize.Level0)
{
    std::shared_ptr<DmAuthManager> authManager =
        std::make_shared<DmAuthManager>(softbusConnector, hiChainConnector, listener, hiChainAuthConnector);
    std::shared_ptr<AuthResponseState> authResponseState = std::make_shared<AuthResponseSyncDeleteAclNone>();
