...
void HiChainConnectorSixthFuzzTest(const uint8_t* data, size_t size)
{
    ...
    hichainConnector->AddMember(deviceId, jsonObj.dump(-1, ' ', false, nlohmann::detail::error_handler_t::ignore));
    ...
    std::string credentialInfo = jsonObjCre.dump(-1, ' ', false, nlohmann::detail::error_handler_t::ignore);
