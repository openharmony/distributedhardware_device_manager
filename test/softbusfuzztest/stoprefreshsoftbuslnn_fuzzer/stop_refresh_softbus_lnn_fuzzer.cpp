...
#include "stop_refresh_softbus_lnn_fuzzer.h"

namespace OHOS {
namespace DistributedHardware {
void StopRefreshSoftbusLNNFuzzTest(const uint8_t* data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::DistributedHardware::StopRefreshSoftbusLNNFuzzTest(data, size);
