...
DM_EXPORT extern const uint32_t DM_IDENTICAL_ACCOUNT;
DM_EXPORT extern const uint32_t DM_POINT_TO_POINT;
DM_EXPORT extern const uint32_t DM_ACROSS_ACCOUNT;
DM_EXPORT extern const uint32_t DM_INVALIED_BINDTYPE;
DM_EXPORT extern const uint32_t DEVICE;
...
public:
    ...
    DM_EXPORT bool CheckSinkDevIdInAclForDevBind(const std::string &pkgName,
        const std::string &deviceId);
    DM_EXPORT uint32_t DeleteTimeOutAcl(const std::string &deviceId, int32_t &peerUserId);
    ...
    DM_EXPORT int32_t HandleDevUnBindEvent(int32_t remoteUserId,
        const std::string &remoteUdid, const std::string &localUdid);
    ...
    DM_EXPORT int32_t PutSessionKey(const std::vector<unsigned char> &sessionKeyArray,
