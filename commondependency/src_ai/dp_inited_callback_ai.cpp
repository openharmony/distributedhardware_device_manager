...
#include "dp_inited_callback_ai.h"
...
//LCOV_EXCL_START
DpInitedCallbackAi::DpInitedCallbackAi()
{}

DpInitedCallbackAi::~DpInitedCallbackAi()
{}

int32_t DpInitedCallbackAi::OnDpInited()
{
    LOGE("In.");
...
void DpInitedCallbackAi::PutAllTrustedDevices()
{
    LOGE("In.");
...
bool DpInitedCallbackAi::ConvertToTrustedDeviceInfo(const std::unordered_map<std::string, DmAuthForm> &authFormMap,
