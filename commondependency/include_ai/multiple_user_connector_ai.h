...
#ifndef OHOS_DM_MULTIPLE_USER_CONNECTOR_AI_H
#define OHOS_DM_MULTIPLE_USER_CONNECTOR_AI_H
...
class MultipleUserConnectorAi {
public:
    /**
     * @tc.name: MultipleUserConnectorAi::GetCurrentAccountUserID
    ...
    /**
     * @tc.name: MultipleUserConnectorAi::SetSwitchOldUserId
    ...
    /**
     * @tc.name: MultipleUserConnectorAi::GetSwitchOldUserId
    ...
    /**
     * @tc.name: MultipleUserConnectorAi::GetOhosAccountId
    ...
    /**
     * @tc.name: MultipleUserConnectorAi::SetSwitchOldAccountId
     * @tc.desc: Set Switch Old UserId of the Multiple User Connector
     * @tc.type: FUNC
     */
    ...
    /**
     * @tc.name: MultipleUserConnectorAi::GetSwitchOldAccountId
     * @tc.desc: Get Switc hOld UserId of the Multiple User Connector
     * @tc.type: FUNC
     */
    ...
    /**
     * @tc.name: MultipleUserConnectorAi::SetSwitchOldAccountName
    ...
    /**
     * @tc.name: MultipleUserConnectorAi::GetOhosAccountName
    ...
    /**
     * @tc.name: MultipleUserConnectorAi::GetSwitchOldAccountName
...
#endif // OHOS_DM_MULTIPLE_USER_CONNECTOR_AI_H
