...
DM_EXPORT uint64_t DeviceProfileConnector::GetTokenIdByNameAndDeviceId(
...
DM_EXPORT void DeviceProfileConnector::DeleteAclForUserRemoved(std::string localUdid,
    int32_t userId, std::vector<std::string> peerUdids, std::multimap<std::string, int32_t> &peerUserIdMap)
{
...
DM_EXPORT uint32_t DeviceProfileConnector::DeleteTimeOutAcl(const std::string &deviceId, int32_t &peerUserId)
{
    std::vector<AccessControlProfile> profiles = GetAccessControlProfile();
    LOGI("AccessControlProfile size is %{public}zu", profiles.size());
    uint32_t res = 0;
...
DM_EXPORT int32_t DeviceProfileConnector::CheckAccessControl(
...
DM_EXPORT int32_t DeviceProfileConnector::CheckIsSameAccount(
    const DmAccessCaller &caller, const std::string &srcUdid,
    const DmAccessCallee &callee, const std::string &sinkUdid)
{
...
DM_EXPORT int32_t DeviceProfileConnector::HandleDevUnBindEvent(int32_t remoteUserId,
...
DM_EXPORT DmOfflineParam DeviceProfileConnector::HandleAppUnBindEvent(
