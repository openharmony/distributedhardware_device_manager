...
__attribute__ ((visibility ("default")))std::string GetAnonyString(const std::string &value);
...
__attribute__ ((visibility ("default")))bool IsInt32(const JsonItemObject &jsonObj, const std::string &key);
...
__attribute__ ((visibility ("default")))std::string SafetyDump(const JsonItemObject &jsonObj);
