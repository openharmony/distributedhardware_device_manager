...
#ifndef OHOS_DM_IPC_START_SERVICE_DISCOVERY_REQ_H
#define OHOS_DM_IPC_START_SERVICE_DISCOVERY_REQ_H

#include "ipc_req.h"

namespace OHOS {
namespace DistributedHardware {
class IpcStartServiceDiscoveryReq : public IpcReq {
...
//this code line need delete: 28 - 36
    ...
    void SetDmDiscParam(const DmDiscoveryServiceParam &discDmParam)
    {
        discDmParam_ = discDmParam;
    }
...
#endif // OHOS_DM_IPC_START_SERVICE_DISCOVERY_REQ_H