...
enum {
    ...
    ERR_DM_UNSUPPORTED_AUTH_TYPE = 96929760,
    ERR_DM_AUTH_BUSINESS_BUSY = 96929761,
    ERR_DM_AUTH_OPEN_SESSION_FAILED = 96929762,
    ERR_DM_AUTH_PEER_REJECT = 96929763,
    ERR_DM_AUTH_REJECT = 96929764,
    ERR_DM_AUTH_FAILED = 96929765,
    ERR_DM_AUTH_NOT_START = 96929766,
    ERR_DM_AUTH_MESSAGE_INCOMPLETE = 96929767,
    ERR_DM_CREATE_GROUP_FAILED = 96929768,
    ...
    ERR_DM_BIND_USER_CANCEL = 96929780,
    ...
    ERR_DM_BIND_USER_CANCEL_ERROR = 96929785,
    ...
    ERR_DM_AUTH_CODE_INCORRECT = 96929796,
    ERR_DM_META_TYPE_INVALID = 96929797,
    ERR_DM_LOAD_CUSTOM_META_NODE = 96929798,
    ERR_DM_BIND_USER_CANCEL_PIN_CODE_DISPLAY = 96929799,
