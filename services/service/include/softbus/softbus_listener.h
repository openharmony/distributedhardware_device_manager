...
public:
    ...
    static void CacheDeviceInfo(std::string deviceId, std::shared_ptr<DeviceInfo> infoPtr);
    static int32_t GetIPAddrTypeFromCache(const std::string &deviceId, std::string ip, ConnectionAddrType &addrType);
private:
