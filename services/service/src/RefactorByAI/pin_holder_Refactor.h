...
#ifndef OHOS_PIN_HOLDER_REFACTOR_H
#define OHOS_PIN_HOLDER_REFACTOR_H
...
private:
    ...
    void SecureClearSensitiveData();
    bool ValidatePkgName(const std::string &pkgName);
private:
...
#endif // OHOS_PIN_HOLDER_REFACTOR_H
