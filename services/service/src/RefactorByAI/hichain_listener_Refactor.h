...
#ifndef OHOS_DM_HICHAIN_LISTENER_REFACTOR_H
#define OHOS_DM_HICHAIN_LISTENER_REFACTOR_H
...
private:
    ...
    bool ValidatePeerUdid(const char *peerUdid);
};
} // namespace DistributedHardware
} // namespace OHOS
#endif // OHOS_DM_HICHAIN_LISTENER_REFACTOR_H
