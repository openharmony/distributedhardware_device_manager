...
#ifndef OHOS_DM_MINE_SOFTBUS_LISTENER_REFACTOR_H
#define OHOS_DM_MINE_SOFTBUS_LISTENER_REFACTOR_H
...
private:
    ...
    static void ClearSensitiveBuffer(char *buffer, size_t len);
    static bool ValidateBroadcastDataLen(size_t hDataLen, size_t tlvDataLen, size_t base64OutLen, size_t outLen);
};
} // namespace DistributedHardware
} // namespace OHOS
#endif // OHOS_DM_MINE_SOFTBUS_LISTENER_REFACTOR_H
