...
class AuthCert {
public:
    static AuthCert &GetInstance(void)
    {
        static AuthCert instance;
        return instance;
    }
    ...
    int32_t GenerateCertificateV2(DmCertChain &dmCertChain, const int64_t random);
    int32_t VerifyCertificateV2(const DmCertChain &dmCertChain, const char *deviceIdHash, const int64_t random);

private:
    AuthCert();
    ~AuthCert();
    bool IsDMAdapterAuthCertLoaded();
