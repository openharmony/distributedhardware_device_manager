 ...
 * Source: services/implementation/include/authentication_v2/dm_auth_manager_base.h (unchanged).
 * Principle tags at changed sites: [P3] input validation, [P13] switch default note,
 * [P18] user isolation.
 */

#ifndef OHOS_DM_AUTH_ADAPTER_V2_REFACTOR_H
#define OHOS_DM_AUTH_ADAPTER_V2_REFACTOR_H
...
protected:
    ...
    // [P13] note: this flag gates the new-to-old protocol fallback (a compatibility path).
    // The upstream default is true; changing it requires escalation per the compatibility
    // fallback rule, so the default is deliberately preserved here.
...
#endif  // OHOS_DM_AUTH_ADAPTER_V2_REFACTOR_H
